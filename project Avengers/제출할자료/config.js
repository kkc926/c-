...
var config = {
	...
	modules: [
...

		{
			...
			classes:"known",
			config: {
			   key: 'AIzaSyBs6bmkab2O5efgf0WKqr9YB4HeSqpQuf8',
			   directionsRequest: {
...

		  {
			...
			config: {
				calendars: [
					{
						symbol: "calendar-check",
						url: "https://calendar.google.com/calendar/ical/kkc829292%40gmail.com/private-c6183d5fe6690cabb75d162c207d285e/basic.ics"
					}
				]
			}
		},
		{
			...
			config: {
			   calendars: [{
				  symbol: "calendar-check",
				  url:"https://calendar.google.com/calendar/ical/kghvaluable%40gmail.com/private-be065b31372838638cecbe3b6c99b196/basic.ics"
			   }]
			}
		 },
		 {
			...
			config: {
			   calendars: [{
				  symbol: "calendar-check",
				  url:"https://calendar.google.com/calendar/ical/ljw2247%40gmail.com/private-6e300aa73b877de65f83a846d535d730/basic.ics"
			   }]
			}
		 },
		 {
			...
			config: {
			   calendars: [{
				  symbol: "calendar-check",
				  url:"https://calendar.google.com/calendar/ical/hyunsoodii%40gmail.com/private-098015c21d7df5a89650c4c3faf7dd3d/basic.ics"
			   }]
			}
		 },
		...
		},
		{
			...
			classes:"known",
			config: {
			  clientID: "ea762ac44bfe48039dcabb7efc61dd82",
			  clientSecret: "6a4b614e5555400f89e11c5246f678fd",
			  accessToken: "BQBEdozq0Mgwz2u00t7OQK_EmziznPb5pij7ooDV7tIFm6kl30Q2zHN5NiVgCwwSHzYqcTRuDH03HNNf1SsGsQ8hLb9HXE3lDvAKcT00qkwGI1n3GGrkmouPvI0iNCP1XPR1PFBFCE4SILbuYKgcMQHCVTqcjKU_HeDI0ukx0Qs2Eg",
			  refreshToken: "AQBEDsaH3jkfVe04EEOJ63ZIV0nkGfYsEowX-BcBlYVxuasZx8pjW0p3rnCAiZETMmDEedV6Ji6qCx1pCcdl4WBOcocAL-oqz3WX2-xbrZG4buT3ch8YIhe_Udaopsvo6do"
			}
		  },
